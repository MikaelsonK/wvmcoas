...
export function RegisterResidentForm({ onSuccess }: { onSuccess?: () => void }) {
...
export function RegisterResidentModalTrigger() {
  ...
  return (
    <>
      ...
      <DialogModal isOpen={isOpen} onOpenChange={setIsOpen} title="Register Resident">
        <RegisterResidentForm onSuccess={() => setIsOpen(false)} />
      </DialogModal>
    </>
  );
}
